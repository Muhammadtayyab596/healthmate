...
const MedicineDetail = () => {
  ...
  return (
    <>
      <Helmet>
        <title> Medicine Detail | HealthMate </title>
      </Helmet>
      <Container>
              ...
              <Card>
                <CardContent>
                  ...
                  <Box sx={{ my: 2 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ fontSize: '14px' }}>
                      {medicineData.Uses ? medicineData.Uses : 'N/A'}
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ fontSize: '14px' }}>
                      {medicineData.SideEffects ? medicineData.SideEffects : 'N/A'}
                    </Typography>
                  </Box>
                  ...
                  <Stack direction="row" alignItems="center" sx={{ mt: 2, gap: '15px' }}>
                    ...
                    <Typography sx={{ lineHeight: 1.3, color: 'red', fontSize: '16px', fontWeight: 'bold' }}>
